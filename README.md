...
Він приймає на вхід текст та запам'ятовує зв'язки між словами, а цього генерує речення заданої довжини на основі вхідної інформації.
...
Токенізація - процес перетворення тексту в окремі частинки - слова та пунктуацію.
